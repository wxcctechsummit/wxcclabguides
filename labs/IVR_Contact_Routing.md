...
- The audio prompts required for the script build out are wav files. The whole bundle of wav files [can be found here](https://wxcctechsummit.github.io/wxcclabguides/prompts/Tech_Summit_2021_WAVFiles.zip){:target="\_blank"}
