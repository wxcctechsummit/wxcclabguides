...
- [Part 2: Onboardin CH Agent as WxM User](#Part-2-Onboardin-CH-Agent-as-WxM-User)

    - [a) Create WxM User and Generate API key](#a-Create-WxM-User-and-Generate-API-key)

    - [b) Identfy Org-ID, CH User-ID and email of Agent](#b-Identfy-Org-ID-CH-User-ID-and-email-of-Agent)
...
- [Part 4: Configure Feedback node in Flow](#Part-4-Configure-Feedback-node-in-Flow)
    ...
    - [b) Test Voice interaction and confirm that the survey is received by the caller's email](#b-Test-Voice-interaction-and-confirm-that-the-survey-is-received-by-the-caller's-email)
...
- Login to the WxM console by accessing https://cx.cloudcherry.com
...
## Part 2: Onboardin CH Agent as WxM User
...
### b) Identfy Org-ID, CH User-ID and email of Agent
