...
5. Create/Upload Email flow
6. Add Authorizations for each of the Engage and WxCC nodes
7. Demo 
...
| --- | --- | --- | --- |
| 1.0 | Initial Release | Naveen Kumar Narasimhan Almeti (naveenkn) | 21 Oct 2021 |
