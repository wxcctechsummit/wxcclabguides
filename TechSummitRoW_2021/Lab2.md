...
- [Part 1: Setup a Simple Flow and make a test call](#part-1-setup-a-simple-flow-and-make-a-test-call)
  ...
  - [3. Verify/Upload the Audio Prompts, Create the Entry Point Flow.](#3-verify-the-audio-prompts-create-the-entry-point-flow)
  - [4. Configure and Publish the Flow](#4-configure-and-publish-the-flow)
  - [5. Configure the Entry Point Routing Strategy](#5-configure-the-entry-point-routing-strategy)
  - [6. Make a test call](#6-make-a-test-call)
